...
//     cout << arr1 << endl;
//     cout << arr1.remove(5) << endl;
//     cout << arr1.remove(0) << endl;

//     cout << arr1 << endl;

//     cout << arr1.remove(2) << endl;
...
//     arr1.clear();
//     if(arr1.isEmpty()) cout << "Clear works correctly" << endl;
//     cout << arr1 << endl;
...
//     cout << clist.remove(4) << ": " << clist << endl;
